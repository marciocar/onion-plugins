...
name: code-review
description: |
  [Alias] Redireciona para /onion:setup-code-review (setup de code review no CI).
...
Comando canônico: meta/setup-code-review.md. Os argumentos são idênticos. Este alias é mantido por compatibilidade e será removido em iteração futura — atualize seus atalhos/documentação para `/onion:setup-code-review`.
