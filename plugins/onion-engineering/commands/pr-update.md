...
- ✅ Respeita mapeamento Phase→Subtask do context.md (formato canônico na [SSOT](${CLAUDE_PLUGIN_ROOT}/kb/gitflow-patterns.md#contrato-de-sessão-de-desenvolvimento))
