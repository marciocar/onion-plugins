...
- **Command integration**: invocado como agente (via @onion ou diretamente) — não há categoria de comando `architect/`; diagramas via `/onion-product:build-tech-docs` e correlatos
