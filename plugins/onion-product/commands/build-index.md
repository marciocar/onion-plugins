...
- Junto com `/onion:kb-freshness` (frescor de conteúdo) e `/onion-product:validate-docs`.
...
| `business-context/` | contexto de negócio (spec-as-code) | **template** no framework (só `README.md`); **populado no projeto-alvo** por `/onion-product:build-business-docs` |
| `technical-context/` | contexto técnico (C4/ADR, spec-as-code) | **template** no framework; populado no alvo por `/onion-product:build-tech-docs` |
...
### `/onion-product:build-index` (sem argumento) — reconstrói o hub `docs/INDEX.md`
...
### `/onion-product:build-index <seção>` — reconstrói o `index.md` daquela seção
...
```bash
/onion-product:build-index                      # reconstrói o hub docs/INDEX.md
/onion-product:build-index knowledge-base       # reconstrói docs/knowledge-base/index.md
/onion-product:build-index business-context     # indexa o contexto de negócio (template ou populado)
/onion-product:build-index technical-context    # indexa o contexto técnico
/onion-product:build-index compliance-context   # indexa o contexto de compliance
```
...
- Este comando **não cria conteúdo** de contexto — para isso use `/onion-product:build-business-docs`, `/onion-product:build-tech-docs`, `/onion-compliance:build-compliance-docs`.

## Referências

- Hub: `docs/INDEX.md`
- Geração de contexto: `/onion-product:build-business-docs`, `/onion-product:build-tech-docs`, `/onion-compliance:build-compliance-docs`
- Frescor de conteúdo: `/onion:kb-freshness`
- Validação: `/onion-product:validate-docs`
