...
🚀 PRÓXIMOS PASSOS:
   ...
   ∟ /onion-product:build-business-docs (contexto de negócio)
   ∟ /onion-product:build-index (atualizar índice mestre)
...
- **Comando complementar**: `/onion-product:build-business-docs`
