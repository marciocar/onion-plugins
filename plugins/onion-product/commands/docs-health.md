...
description: |
  ...
  Diferença vs /onion-product:validate-docs: este é DIAGNÓSTICO read-only (saúde/gaps/recomendações); o validate-docs valida estrutura/links/padrões e pode CORRIGIR (--fix).
