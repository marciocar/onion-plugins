...
description: |
  ...
  Diferença vs /onion-product:docs-health: este VALIDA + corrige (estrutura/links/padrões, com --fix); o docs-health é o diagnóstico read-only (saúde/gaps/recomendações).
