...
#
# Uso : bash ${CLAUDE_PLUGIN_ROOT}/validation/constellation-map.sh [--dir <discussions>] [--json]
...
REPO="$(env -u GIT_DIR -u GIT_WORK_TREE git -C "$DIR" rev-parse --show-toplevel 2>/dev/null || true)"
