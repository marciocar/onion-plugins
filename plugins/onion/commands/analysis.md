...
description: |
  ...
  Diferença vs /onion:analyze-complex-problem: este é o caminho RÁPIDO (template único, sem tipagem, sem gate); o analyze-complex-problem é a análise estruturada para casos críticos (migrações, arquitetura, performance).
