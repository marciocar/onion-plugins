...
# 🔄 /onion:co-evolve — Orientação de co-evolução (core ↔ derivados)
...
- **CONSUMIDOR com 📥:** redigir o **rascunho de processamento** (o que o anúncio pede, o que muda aqui,
  ...
  apresentar e **parar**. Só após confirmação: commitar/relayar (`/onion:co-relay`) e mover.
- **⏰ (qualquer papel):** propor a sessão de **re-teste** das migalhas vencidas via `/onion:diary review`
