...
# /onion:constellation — o 🗺️ Mapa da Constelação de Estudos
...
bash ${CLAUDE_PLUGIN_ROOT}/validation/constellation-map.sh

# JSON estruturado (stars[], scope_collisions[], objective_convergences[])
bash ${CLAUDE_PLUGIN_ROOT}/validation/constellation-map.sh --json

# Um dir de discussões alternativo (ex.: teste)
bash ${CLAUDE_PLUGIN_ROOT}/validation/constellation-map.sh --dir <path>
```
