...
# /onion:context-freshness — Auditoria de Frescor de Contexto de Domínio
...
Reusa o **molde** do [`/onion:kb-freshness`](kb-freshness.md) (fan-out-and-synthesize,
...
5. **Grafo primeiro**: contradição cross-domínio e candidatos `HISTORICAL` são achados estruturados
   — materialize via `/onion:kg` (nó `claim`, `layer: audit`, `trace` ao arquivo) **antes** de
...
⚠  business-context/01-customer/personas.md
   ...
   Ação  : /onion-product:build-business-docs (re-tick) + carimbar data
...
4. Re-executar /onion:context-freshness para confirmar
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
```
...
```bash
/onion:context-freshness                                   # os 3 contextos
/onion:context-freshness docs/business-context/            # só negócio
/onion:context-freshness docs/technical-context/03-domain/ # um subdiretório
```
...
- Molde reusado: [`/onion:kb-freshness`](kb-freshness.md)
- Geradores (primeiro tick): `/onion-product:build-business-docs` · `/onion-product:build-tech-docs` · `/onion-compliance:build-compliance-docs`
