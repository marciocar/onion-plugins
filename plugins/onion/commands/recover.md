...
# 🧅 /onion:recover — Recuperação de Identidade Onion
...
Adapter: `${CLAUDE_PLUGIN_ROOT}/utils/task-manager/adapters/<provider>.md`.
...
[ -f "$REPO/${CLAUDE_PLUGIN_ROOT}/utils/task-manager/adapters/${TM}.md" ] \
...
metadata was missing. Ran /onion:recover to restore.
