...
> Nenhuma entrada ainda. Use \`/onion:diary create\` para criar a primeira migalha.
...
while IFS= read -r f; do
  ...
  # tipo que o /onion:diary não sabe processar. Enum: RFC-0003 §2.3 + /onion:diary (`reflection`
...
*Gerenciado por \`/onion:diary\`. Para criar uma entrada: \`/onion:diary create\`.*
*Para exportar compartilháveis: \`/onion:diary export-sharable\`.*
